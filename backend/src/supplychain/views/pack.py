...
class PackListCreateView(generics.ListCreateAPIView):
    ...
    def get_queryset(self):
            ...
            try:
                ...
                queryset = queryset.filter(
                    ...
                    | Q(
                        ...
                        batch__expiry_date__gte=expiry_from_date,
                    )
                )
            except ValueError:
                pass
        ...
        if expiry_to:
            try:
                ...
                queryset = queryset.filter(
                    ...
                    | Q(
                        expiry_date__isnull=True, batch__expiry_date__lte=expiry_to_date
                    )
                )
            except ValueError:
                pass
        ...
        if shipping_status == "shipped":
            ...
            queryset = queryset.filter(
                shipped_date__isnull=True, status__in=["active", "quarantined"]
            )
        ...
        if expiry_status == "expired":
            ...
            queryset = queryset.filter(
                ...
                | Q(
                    ...
                    batch__expiry_date__lte=soon_date,
                )
            )
...
class PackDeleteView(generics.DestroyAPIView):
    ...
    def destroy(self, request, *args, **kwargs):
        ...
        return Response(
            {"message": "Pack deleted successfully"}, status=status.HTTP_200_OK
        )
