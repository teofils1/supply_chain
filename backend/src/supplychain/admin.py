...
class PackAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Location", {
            "fields": ("location", "warehouse_section")
        }),
        ("Quality Control", {
...
class ShipmentAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ...
        ("Pack Information", {
            "fields": ("pack_count", "total_pack_size"),
            "classes": ("collapse",)
        }),
        ("Status Information", {
        ...
        ("Additional Information", {
            "fields": ("notes", "external_tracking_url"),
            "classes": ("collapse",)
        }),
        ("Timestamps", {
            "fields": ("created_at", "updated_at"),
...
class EventAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Event Information", {
            "fields": ("event_type", "entity_type", "entity_id", "entity_display_name", "timestamp")
        }),
        ("Description", {
        ...
        ("Metadata", {
            "fields": ("metadata", "system_info"),
            "classes": ("collapse",)
        }),
        ("Status", {
            "fields": ("is_critical", "is_alert"),
            "classes": ("collapse",)
        }),
        ("Timestamps", {
            "fields": ("created_at", "updated_at"),
