...
class BatchDetailSerializer(serializers.ModelSerializer):
    ...
    def validate_lot_number(self, value):
        ...
        product = self.initial_data.get('product') or (self.instance.product.id if self.instance else None)
        
        if not product:
            raise serializers.ValidationError("Product is required to validate lot number.")
        ...
        if queryset.exists():
            raise serializers.ValidationError("A batch with this lot number already exists for this product.")
...
class BatchCreateSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        read_only_fields = ["id", "created_at", "is_expired", "days_until_expiry", "shelf_life_remaining_percent"]
