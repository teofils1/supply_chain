...
class EventDetailSerializer(serializers.ModelSerializer):
    ...
    def get_related_product(self, obj):
        ...
        if obj.entity_type == 'product' and obj.content_object:
            ...
            elif hasattr(obj.content_object, 'batch') and hasattr(obj.content_object.batch, 'product'):
    ...
    def get_related_batch(self, obj):
        ...
        elif obj.entity_type == 'pack' and obj.content_object and hasattr(obj.content_object, 'batch'):
